...
class Terkey:
  ...
  def banner(self):
      ...
      print(f'{a}BloodSword'.center(53))
  ...
  def standar(self):
    key = "[['python2 ','python','ESC','HOME','UP','END','PGUP'],['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN']]"
    return key
